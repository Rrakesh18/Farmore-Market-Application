...
function RegisterPage({ navigate }) {
    const [formData, setFormData] = useState({ name: '', email: '', phone: '', password: '', village: '', role: 'farmer' });
    ...
    return (
        <AuthPageWrapper>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="mb-3"><input type="text" placeholder={t('phone')} onChange={(e) => setFormData({...formData, phone: e.target.value})} className="form-control" required /></div>
